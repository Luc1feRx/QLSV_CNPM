<?php
	session_start();
	error_reporting(0);
	$url = "http://localhost:85/ql_sinhvien/";
 ?>
<!DOCTYPE html>
<html lang="vi">
<head>
  <title><?php echo $title;?>Trường Đại Học Công Nghệ Giao Thông Vận Tải</title>
  <meta charset="utf-8">
...
<div class="container">
	<!-- Header -->
	<header>
		<a href="index.php" title="Trường Đại Học Công Nghệ Giao Thông Vận Tải">
			<p>Trường Đại Học Công Nghệ Giao Thông Vận Tải</p>
      <p>UNIVERSITY OF TRANSPORT TECHNOLOGY</p>
		</a>
	</header>
	<!-- End header -->
</div>
